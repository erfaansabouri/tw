                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">اشتراک ها</h3>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <th class="iransans-web">قیمت ماهانه</th>
                            ...
                            @foreach($plans as $plan)
                                <tr>
                                    <td class="iransans-web">{{ $plan->id }}</td>
                                    <td class="iransans-web">{{ $plan->title }}</td>
                                    <td class="iransans-web">{{ $plan->monthly_price ?? '-' }}</td>
                                    <td class="iransans-web">{{ $plan->total_price }}</td>
                                    <td>
