                    ...
                    <div class="card-body">
                        ...
                        <table
                            ...
                            @foreach($avatars as $avatar)
                                <tr>
                                    <td class="iransans-web">{{ $avatar->id }}</td>
                                    <td class="iransans-web">{{ $avatar->panel_title }}</td>
                                    <td class="iransans-web"><img class="img img-thumbnail" width="100" src="{{ $avatar->getFirstMediaUrl('image') }}" alt=""></td>
                                    <td>
                                        <a href="{{ route('admin.avatars.edit', $avatar->id) }}">
                                            <button class="btn btn-primary btn-hover-white btn-sm"><span
                                                    class="fa fa-edit"></span></button>
                                        </a>
                                        <a href="{{ route('admin.avatars.destroy', $avatar->id) }}">
