                    ...
                    <div class="card-body">
                        ...
                        <table
                            ...
                            @foreach($admins as $admin)
                                <tr>
                                    <td class="iransans-web">{{ $admin->id }}</td>
                                    <td class="iransans-web">{{ $admin->name }}</td>
                                    <td class="iransans-web">{{ $admin->email }}</td>
                                    <td>
