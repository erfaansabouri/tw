                    ...
                    <div class="card-body">
                        ...
                        <table
                            ...
                            @foreach($goals as $goal)
                                <tr>
                                    <td class="iransans-web">{{ $goal->id }}</td>
                                    <td class="iransans-web">{{ $loop->index + 1}}</td>
                                    <td class="iransans-web">{{ $goal->small_title }}</td>
                                    <td class="iransans-web">{{ $goal->full_title }}</td>
                                    <td class="iransans-web"><img class="img img-thumbnail" width="100" src="{{ $goal->getFirstMediaUrl('image') }}" alt=""></td>
                                    <td>
                                        <a href="{{ route('admin.goals.edit', $goal->id) }}">
                                            <button class="btn btn-primary btn-hover-white btn-sm"><span
                                                    class="fa fa-edit"></span></button>
                                        </a>
                                        <a href="{{ route('admin.goals.destroy', $goal->id) }}">
