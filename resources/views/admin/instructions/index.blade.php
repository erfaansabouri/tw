                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">راهنما های اپلیکیشن
                    ...
                    <div class="card-body">
                        ...
                        <!--begin::Search Form-->
                        <div class="mb-7">
                            <form action="{{ route('admin.instructions.index') }}" method="get">
                        ...
                        <table
                            ...
                            @foreach($instructions as $instruction)
                                <tr>
                                    <td class="iransans-web">{{ $instruction->id }}</td>
                                    <td class="iransans-web">{{ $instruction->sort }}</td>
                                    <td class="iransans-web">{{ $instruction->description }}</td>
                                    <td>
                                        <a href="{{ route('admin.instructions.edit', $instruction->id) }}">
                                            <button class="btn btn-primary btn-hover-white btn-sm"><span
                                                    class="fa fa-edit"></span></button>
                                        </a>
                                        <a href="{{ route('admin.instructions.destroy', $instruction->id) }}">
