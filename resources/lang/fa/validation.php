...
return [
    ...
    */
    ...
    'min_digits'             => 'تعداد رقم های :attribute اشتباه است',
    'jdate' => 'تاریخ شمسی اشتباه است.',
    ...
    */
    'attributes' => [
        ...
        "fake_flight_date" => "تاریخ پرواز",
        "flight_class" => "کلاس پرواز",
        "source_airport_id" => "فرودگاه مبدا",
        "destination_airport_id" => "فرودگاه مقصد",
        "place" => "ارائه سرویس",
        "flight_type" => "نوع پرواز",
        "passenger_nationality" => "ملیت مسافرین",
        "source_service_id" => "سرویس مبدا",
        "destination_service_id" => "سرویس مقصد",

        "source_passengers.*.first_name" => "نام مسافر",
        "source_passengers.*.last_name" => "نام خانوادگی مسافر",
        "source_passengers.*.passport" => "پاسپورت مسافر",
        "source_passengers.*.age_type" => "رده سنی مسافر",
        "source_passengers.*.phone_number" => "شماره تماس مسافر",

        "destination_passengers.*.first_name" => "نام مسافر",
        "destination_passengers.*.last_name" => "نام خانوادگی مسافر",
        "destination_passengers.*.passport" => "پاسپورت مسافر",
        "destination_passengers.*.age_type" => "رده سنی مسافر",
        "destination.*.phone_number" => "شماره تماس مسافر",


        "source_sidekicks.*.first_name" => "نام مشایع",
        "source_sidekicks.*.last_name" => "نام خانوادگی مشایع",
        "source_sidekicks.*.passport" => "پاسپورت مشایع",
        "source_sidekicks.*.age_type" => "رده سنی مشایع",
        "source_sidekicks.*.phone_number" => "شماره تماس مشایع",


        "destination_sidekicks.*.first_name" => "نام مشایع",
        "destination_sidekicks.*.last_name" => "نام خانوادگی مشایع",
        "destination_sidekicks.*.passport" => "پاسپورت مشایع",
        "destination_sidekicks.*.age_type" => "رده سنی مشایع",
        "destination_sidekicks.*.phone_number" => "شماره تماس مشایع",
        ...
        "transfer_car_id" => "خودرو",
        "transfer_date" => "تاریخ",
        "transfer_time" => "زمان",
        "transfer_phone_number" => "شماره تماس",
