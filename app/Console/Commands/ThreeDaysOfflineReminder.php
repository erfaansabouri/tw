...
class ThreeDaysOfflineReminder extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'three-days-offline';
    /**
    ...
    public function handle () {
        $users = User::query()
                     ...
                     ->whereDoesntHave('pushNotifications' , function ( $q ) {
                         $q->where('type' , PushNotification::TYPES[ 'THREE_DAYS_OFFLINE' ])
        ...
        foreach ( $users as $user ) {
            $text = "۳ روز به عادت های جدیدت سر نزدی 🙄";
            $data = [
